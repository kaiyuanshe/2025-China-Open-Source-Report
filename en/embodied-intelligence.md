---
title: Open Source Embodied Intelligence
...
1. Ant Group Officially Open-Sources LingBot-Depth, a Next-Generation Spatial Perception Model Based on Masked Depth Modeling. (2026). [ModelScope / CSDN](https://modelscope.csdn.net/69796ccaa16c6648a9859206.html)

1. From “Cognition” to “Action”: CogACT Ushers in a New Paradigm for Intelligent Robotic Manipulation. (2025). [WeChat Article](https://mp.weixin.qq.com/s/qBv4_59pQmJ9PXnMfpKmag)

1. AIR Research | X-VLA Open-Sourced, Setting New Records Across Robotic Benchmarks. (2025). [Tsinghua AIR](https://air.tsinghua.edu.cn/info/1007/2467.htm)

1. Full-Stack Open Source! Going Beyond π0, a Truly Open-Source Foundation Model for Embodied Intelligence Is Here. (2025). [QbitAI](https://www.qbitai.com/2025/09/329142.html)

1. The New Leader in Open-Source Embodied Models? Qianxun Spirit v1.5 Tops RoboChallenge, Bringing the Pi0.5 Era to an End. (2026). [Zhihu](https://zhuanlan.zhihu.com/p/1994053773560145309)

1. ForceRobo Releases DM0, the World’s First Embodied-Native Foundation Model, with the 2.4B-Parameter Version Fully Open-Sourced. (2026). [IT Home](https://www.ithome.com/0/920/880.htm)

1. The World’s First Autoregressive Video-Action World Model, LingBot-VA, Is Now Open Source. (2026). [Zhihu](https://zhuanlan.zhihu.com/p/2000550423925391894)

1. ShengShu Technology: From Motus to MotuBrain—Ranking First on Both General-Purpose World Action Model Leaderboards. (2026). [Tencent News](https://news.qq.com/rain/a/20260430A01KGD00)

1. NVIDIA DreamZero: A Video-Diffusion-Based World Action Model. (2025). [Zhihu](https://zhuanlan.zhihu.com/p/2015542809814397733)

1. Kunlun Tech Officially Open-Sources Matrix-Game: Building a Controllable Interactive World from Images. *Yicai*. (2025). [Yicai](https://www.yicai.com/news/102611300.html)

1. SkyworkAI/Matrix-Game. GitHub. [GitHub Repository](https://github.com/SkyworkAI/Matrix-Game)

1. Tencent Hunyuan Open-Sources Its Latest World Model, Enabling Real-Time Interactive Generation and Long-Term Spatial Memory. *Zhidongxi*. (2025). [Zhidongxi](https://m.zhidx.com/p/522165.html); Tencent-Hunyuan/HY-WorldPlay. GitHub. [GitHub Repository](https://github.com/Tencent-Hunyuan/HY-WorldPlay)

1. LingBot-World World Model Officially Open-Sourced. ModelScope Community. (2026). [Zhihu](https://zhuanlan.zhihu.com/p/2000599754195870537); World-Model Open-Source Wave Converges: Ant Group Releases Three Projects in Succession as Google Opens Its Experience. *China Daily*. (2026). [China Daily](https://cn.chinadaily.com.cn/a/202601/30/WS697c4bc0a310942cc499d788.html)

1. RoboTwin 2.0: A Scalable Data Generator and Benchmark with Strong Domain Randomization for Robust Bimanual Robotic Manipulation. (2025). [Project Website](https://robotwin-platform.github.io/); arXiv:2506.18088.

1. VLABench: A Large-Scale Benchmark for Language-Conditioned Robotics Manipulation with Long-Horizon Reasoning Tasks. Institute for Trustworthy Embodied Intelligence, Fudan University. (2024). [VLABench](https://vlabench.github.io/); RoboHiMan: A Hierarchical Evaluation Paradigm for Compositional Generalization in Long-Horizon Manipulation. (2025).

1. Open-Source Embodied Intelligence Week: Navigation, Manipulation, Motion Foundation Models and Datasets Released at Scale. Shanghai Artificial Intelligence Laboratory. (2025). [Shanghai AI Lab](https://www.shlab.org.cn/news/5444209); InternRobotics / EBench. [EBench](https://internrobotics.shlab.org.cn/)

1. Shanghai Jiao Tong University Gives Embodied Intelligence a “Standardized Exam”—Could This Become the Robot Equivalent of LMArena? (2026). [Zhihu](https://zhuanlan.zhihu.com/p/1999185873640637706)

1. Based on Tens of Thousands of Real-Robot Evaluations, RoboChallenge Releases Its First Annual Report. (2026). [QbitAI](https://www.qbitai.com/2026/01/374597.html)

1. Three Million Sample Pairs, 2.71 TB of Data: Ant Group’s LingBot-Depth-Dataset Open-Sources a Large-Scale Spatial Perception Dataset. (2026). [Zhihu](https://zhuanlan.zhihu.com/p/2022954921507529088); robbyant/LingBot-Depth-Dataset. ModelScope / Hugging Face. [Hugging Face Dataset](https://huggingface.co/datasets/robbyant/mdm_depth)

1. ModelScope Community & CCF Intelligent Robotics Committee. (2026). *2025 EAI White Paper: Top 10 Educational Projects and Top 10 Datasets*. [ModelScope](https://modelscope.cn/learn/6060)

1. Official Release Information for the RoboMIND Dataset. (2024–2026).

1. Official Release Information for the AgiBot World Dataset. (2024).

1. RealMan Open-Sources the World’s First High-Quality Real-Robot Dataset with the Largest Number of Modalities. *QbitAI*. (2025-11-24). [QbitAI](https://www.qbitai.com/2025/11/355861.html); Project Website. [RealMan Dataset](https://realmanrobot.github.io/real_source_dataset)

1. EgoLive: A 1,680-Hour Egocentric Dataset of Real-World Tasks. (2026). [Zhihu](https://zhuanlan.zhihu.com/p/2032440515615011207); Dataset. [JD Robot Data Market](https://robotdata-market.jdcloud.com/console/market)

1. TASTE-Rob: A Large-Scale Human-Hand Interaction Video Dataset for Generalizable Robotic Manipulation (CVPR 2025). The Chinese University of Hong Kong, Shenzhen. (2025). [TASTE-Rob](https://taste-rob.github.io/); [arXiv](https://arxiv.org/abs/2503.11423)

1. AgiBot Releases the Large-Scale AgiBot Digital World Simulation Framework and Open-Sources a Massive Simulation Dataset. (2025). [Zhihu](https://zhuanlan.zhihu.com/p/26213022118)

1. DexGraspNet: A Large-Scale Robotic Dexterous Grasp Dataset for General Object Grasping. Peking University (He Wang Research Group). (2023–2025). [Project Website](https://pku-epic.github.io/DexGraspNet/); [arXiv](https://arxiv.org/abs/2210.02697)

1. Galbot and Tsinghua University Open-Source the OpenWBT Whole-Body Teleoperation System. (2025). [QbitAI](https://www.qbitai.com/2025/06/291904.html)

1. Dexbotic Goes Open Source! VLA Performance Improves by 46%, with 100% Success on a Real-Robot Stacking Task. *Synced*. (2025). [Zhihu](https://zhuanlan.zhihu.com/p/81733537638); Dexmal/dexbotic. GitHub. [GitHub Repository](https://github.com/dexmal/dexbotic)

1. StarVLA: A Lego-like Codebase for Vision-Language-Action Model Developing. Hong Kong University of Science and Technology and the Open-Source Community. (2026). [GitHub Repository](https://github.com/starVLA/starVLA); arXiv:2604.05014; [Project Website](https://starvla.github.io/); The “PyTorch Moment” for VLA Has Arrived: HKUST and the Open-Source Community Release StarVLA. *Machine Intelligence*. (2026-05-09). [Zhihu](https://zhuanlan.zhihu.com/p/2036453582724142506)

1. LeRobot v0.4.0: Major Improvements to Open-Source Robot Learning. (2025). [Hugging Face](https://huggingface.co/blog/zh/lerobot-release-v040); LeRobot v0.5.0: Scaling Every Dimension. (2026). [Hugging Face](https://huggingface.co/blog/lerobot-release-v050); huggingface/lerobot. GitHub. [GitHub Repository](https://github.com/huggingface/lerobot); TheRobotStudio/SO-ARM100. [GitHub Repository](https://github.com/TheRobotStudio/SO-ARM100)

1. RLinf Open-Sourced: The First Large-Scale Reinforcement Learning Framework for Embodied Intelligence with Integrated Rendering, Training, and Inference. Tsinghua University / Zhongguancun Academy / UnknowAI. (2025–2026). [Zhihu](https://zhuanlan.zhihu.com/p/1994163320408789692); RLinf/RLinf. GitHub. [GitHub Repository](https://github.com/RLinf/RLinf); arXiv:2509.15965.

1. AgiBot Open-Sources Its Self-Developed Robot Operating System, “Lingqu OS.” *IT Home*. (2026). [Tencent Cloud Developer](https://cloud.tencent.com/developer/news/3639837)

1. Overview of Open-Source Initiatives from Five Major Domestic Embodied-Intelligence Robot Companies (OpenLoong / AimRT). (2025). [Zhihu](https://zhuanlan.zhihu.com/p/1898468293460865377); loongOpen/OpenLoong. GitHub. [GitHub Repository](https://github.com/loongOpen/openloong)

1. AGIROS Intelligent Robot Operating System Open-Source Community. Institute of Software, Chinese Academy of Sciences. (2025). [Institute of Software, CAS](http://www.is.cas.cn/xwdt2016/rdxw2016/202506/t20250630_7876597.html); Gitee × AGIROS: Building Domestic Embodied-Intelligence Infrastructure with the Institute of Software, CAS. (2025). [Zhihu](https://zhuanlan.zhihu.com/p/1977375926506504643)

1. dora-rs: Dataflow-Oriented Robotic Architecture. [GitHub Repository](https://github.com/dora-rs/dora); Building High-Performance Robotic Applications with dora-rs: From Theory to Practice. (2025). [CNBlogs](https://www.cnblogs.com/databank/p/19376737)

1. Giving Robots Instinctive Reactions: Tsinghua Open-Sources a Unified Framework for Parkour and Off-Road Hiking (Project Instinct). BAAI Community. (2026). [BAAI Community](https://hub.baai.ac.cn/view/52110); A Scalable Perceptive Parkour Framework for Humanoids. arXiv:2601.07718. [Project Instinct](https://project-instinct.github.io/)

1. Reshaping the R&D Paradigm for Embodied Intelligence: AgiBot Releases Genie Sim 3.0. (2026). [Zhihu](https://zhuanlan.zhihu.com/p/1992920959561249481)

1. The Best Robot Developer Kit Under RMB 1,000 Has Arrived: D-Robotics Launches the RDK X5. (2024). [QbitAI](https://www.qbitai.com/2024/09/193434.html)

1. roboto_origin: Fully Open-Source DIY Humanoid Robot. RoboParty. [GitHub Repository](https://github.com/Roboparty/roboto_origin); A Rising Star in Humanoid Robotics from the HIT Ecosystem: A Fully Open-Source 3 m/s Prototype Developed in Less Than a Year. *Ifeng*. (2026). [Ifeng](https://i.ifeng.com/c/8q2hN71PXlS)

1. DEEP Robotics, the Robot-Dog Maker: What Supports Its 41× Price-to-Sales Ratio? (2026). [TMTPost](https://www.tmtpost.com/8003855.html)
